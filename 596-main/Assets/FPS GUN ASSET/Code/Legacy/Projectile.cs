...
public class Projectile : MonoBehaviour {
	...
	private void OnCollisionEnter (Collision collision)
	{
		...
		// Handle collisions with paintings
		if (collision.gameObject.CompareTag("Frame"))
		{
			// Assume the ArtManager is attached to a GameObject tagged as "ArtController"
			Debug.Log("Hit");
			ArtManager artManager = GameObject.FindGameObjectWithTag("ArtController").GetComponent<ArtManager>();
			if (artManager != null)
			{
				artManager.CheckAnswer(collision.gameObject);
			}
